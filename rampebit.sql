...
CREATE TABLE IF NOT EXISTS `Ramspebit`.`Empleado` (
  ...
  PRIMARY KEY (`idEmpleado`, `Pension_idPension`, `Caja_compensacion_idCaja_compensacion`, `Tipo_contrato_idTipo_contrato`, `Tipo_documento_idTipo_documento`, `Genero_idGenero`, `Cuenta_idCuenta`),
