  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active"><a href="#"><i class="glyphicon glyphicon-filter"></i> <span>Producción</span></a></li>
        <li class="active"><a href="#"><i class="glyphicon glyphicon-list-alt"></i> <span>Ficha Técnica</span></a></li>
         <li class="treeview">
        ...
        <li class="treeview">
         ...
         <li class="treeview">
          <a href="#"><i class="glyphicon glyphicon-hourglass"></i> <span>Pedidos</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
